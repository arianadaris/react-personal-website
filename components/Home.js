    ...
    return (
        <Container>
            ...
            <MediaQuery maxWidth={480}>
                <Section>
                    <Wrap style={{ paddingRight: '20px', marginLeft: '-130px' }}>
                        <ItemText>
                            <TextH1 style={{ fontSize: '24px' }}><h1>Hi, I'm</h1></TextH1>
                            <TextH1 style={{ fontSize: '24px', lineHeight: 0 }}><h1>Ariana Daris</h1></TextH1>
                            <TextH3 style={{ fontSize: '22px', marginTop: '60px' }}>A UX/UI Designer who wants to<br></br>make the Internet feel more like home.</TextH3>
                        </ItemText>

    ...
    return (
        <Container>
            ...
            <MediaQuery maxWidth={480}>
                <TextH1 style={{ fontSize: '24px', marginLeft: '10%' }}>MY WORK</TextH1>
                <TextH3 style={{ fontSize: '32px', marginLeft: '10%', marginTop: '-15px' }}>Personal Projects</TextH3>
                <TextH2 style={{ fontSize: '18px', marginTop: '20px', marginLeft: '10%', marginBottom: '280px', fontStyle: 'italic' }}>Hmm... This page isn't very mobile friendly yet.</TextH2>
            </MediaQuery>
            <Footer />
        </Container>
    );
